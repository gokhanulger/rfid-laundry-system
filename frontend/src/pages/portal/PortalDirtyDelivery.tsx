...
import { Shirt, Loader2, ChevronLeft, Send, CheckCircle2, Clock, Plus, Trash2 } from 'lucide-react';
...
export function PortalDirtyDelivery() {
  ...
  return (
    <div className="p-4 md:p-6 bg-gray-50 min-h-screen">
              ...
              >
                <div className="flex items-center justify-between mb-2">
                  <span className="text-sm text-gray-500">
                    <span className="font-bold text-orange-600 mr-2">No: {d.declarationNo ?? '-'}</span>
      ...
      {/* Kirli Irsaliye Detay Modal (ortak bilesen) */}
      {selected && (
        <DirtyWaybillModal
          declaration={selected}
          hotelName={user?.tenantName || 'Otel'}
