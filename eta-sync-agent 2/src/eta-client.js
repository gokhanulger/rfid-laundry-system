...
EtaClient.prototype.createIrsaliye = function(irsaliye) {
  ...
  .then(function(refNo) {
    ...
    var irsfisQuery =
      ...
      "IRSFISACIKLAMA1, IRSFISSAAT, IRSFISKAYONC, IRSFISGENTOPLAM, IRSFISFIRMA) " +
      "VALUES (@refNo, @tarih, 1, @cariKod, @cariUnvan, @aciklama, @saat, 1, @toplamTutar, @firma)";
    ...
    return self.pool.request()
      ...
      .then(function() {
        ...
        var carfisQuery =
          ...
          "CARFISACIKLAMA1, CARFISBORCTOP, CARFISKAYONC, CARFISFIRMA) " +
          "VALUES (@refNo, @tarih, 1, @cariKod, @cariUnvan, @aciklama, @toplamTutar, 1, @firma)";
          ...
          (function(satir, lineIndex) {
            carharPromise = carharPromise.then(function() {
              ...
              var carharQuery =
                ...
                "CARHARBORC, CARHARKAYONC, CARHARSIRANO, CARHARFIRMA) " +
                "VALUES (@refNo, @tarih, 1, @cariKod, @tutar, 1, @siraNo, @firma)";
      ...
      .then(function() {
        ...
        var stkfisQuery =
          ...
          "STKFISACIKLAMA1, STKFISKAYONC, STKFISTOPTUT, STKFISFIRMA) " +
          "VALUES (@refNo, @tarih, 1, @cariKod, @aciklama, 1, @toplamTutar, @firma)";
          ...
          (function(satir, lineIndex) {
            promise = promise.then(function() {
              ...
              var irsharQuery =
                ...
                "IRSHARKAYONC, IRSHARSIRANO, IRSHARFIRMA) " +
                "VALUES (@refNo, @tarih, 1, @cariKod, @stokKod, @birim, @miktar, @fiyat, @tutar, 1, @siraNo, @firma)";
              ...
              return self.pool.request()
                ...
                .then(function() {
                  ...
                  var stkharQuery =
                    ...
                    "STKHARKAYONC, STKHARSIRANO, STKHARFIRMA) " +
                    "VALUES (@refNo, @tarih, 1, @cariKod, @stokKod, @birim, @miktar, @fiyat, @tutar, 1, @siraNo, @firma)";
